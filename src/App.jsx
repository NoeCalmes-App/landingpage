      ...
      <footer className="reveal bg-brand py-14 px-6">
        <div className="flex flex-col items-center text-center gap-8 max-w-275 mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="mailto:contact@noecalmes.fr" aria-label="Email" className="w-9 h-9 flex items-center justify-center rounded-[8px] bg-white text-brand hover:opacity-80 transition-opacity">
