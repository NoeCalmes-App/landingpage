      ...
      <footer className="reveal bg-brand py-14 px-6">
        <div className="flex flex-col items-center text-center gap-8 max-w-275 mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.instagram.com/noe.calmes/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 flex items-center justify-center rounded-[8px] bg-white text-brand hover:opacity-80 transition-opacity">
              <svg width="19" height="19" viewBox="0 0 24 24" fill="currentColor">
