...
function App() {
  ...
  useEffect(() => {
    const onScroll = () => { if (window.scrollY > 50) setHasScrolled(true) }
    ...
    <div ref={scrollRef}>
      ...
      >
        <div className="anim-hero max-w-275 mx-auto w-full">
          ...
          {/* Proof */}
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-8 mt-14 md:mt-14">
      ...
      <a
        href="https://api.whatsapp.com/send/?phone=33658308210&text&type=phone_number&app_absent=0"
        target="_blank"
        rel="noopener noreferrer"
