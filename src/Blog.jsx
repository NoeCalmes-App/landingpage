...
export const BLOG_ARTICLES = [
  {
    ...
    finalCta: 'audit',
    content: `
      <p>La très grande majorité des applications publiées sur les stores ne génère presque aucun revenu. Ce n'est pas une question de chance, ni de qualité du code, ni même de nombre de téléchargements. C'est presque toujours la même cause : l'application a été conçue comme un outil, pas comme un produit qui vend. La bonne nouvelle, c'est que les raisons sont identifiables une par une, et qu'elles se corrigent.</p>
      <p>Je m'appelle Noé Calmes, je conçois des applications mobiles pensées pour générer des revenus. J'ai publié plus de 20 applications. Une application que j'ai conçue génère environ <strong>13 000 € par mois</strong> avec une idée banale et un volume de téléchargements modeste. J'ai aussi vu l'inverse de très près : la première version de Hush a dépassé 300 000 utilisateurs sans modèle de revenu construit dès le départ. Beaucoup d'utilisateurs et peu de revenus, c'est le scénario le plus fréquent, et le plus évitable.</p>

      <h2>Raison 1 : le modèle de revenu a été décidé à la fin</h2>
      <p>C'est de loin la cause principale. Le projet démarre par les fonctionnalités, le développement dure des mois, et la question du paiement arrive une semaine avant la mise en ligne. À ce stade, il ne reste qu'une option : coller un écran d'abonnement quelque part et espérer. Le résultat est prévisible, personne ne paie, parce que rien dans le parcours n'a été construit pour amener l'utilisateur à ce moment.</p>
      ...
      <p>Ce moment doit arriver dans les deux premières minutes. Sur une application de suivi, c'est le premier repas enregistré et le chiffre affiché juste après. Identifie ce moment sur ton produit, puis supprime tout ce qui se met entre l'ouverture et lui. Chaque écran intermédiaire coûte des utilisateurs, donc des clients.</p>

      <h2>Raison 3 : l'offre payante arrive au mauvais moment</h2>
      <p>Deux erreurs symétriques. La première, l'écran d'abonnement s'affiche dès l'ouverture, avant que l'utilisateur sache ce que fait l'application. Il ferme, il désinstalle. La seconde, l'offre est cachée dans les réglages et n'apparaît jamais dans le parcours. Personne ne la voit, donc personne ne l'achète.</p>
      ...
      <p>Un prix choisi en regardant vaguement un concurrent est un prix qui laisse de l'argent sur la table ou qui bloque la conversion. Le prix dépend de la fréquence d'usage et de ce que ton application remplace. Une application ouverte tous les jours qui économise du temps réel supporte un abonnement mensuel. Une application ouverte une fois par mois ne le supportera pas, elle vivra mieux avec un achat unique ou un abonnement annuel.</p>
      ...
      <p>On me présente souvent des idées comme si l'idée décidait du résultat. Elle décide de très peu. L'application à 13 000 € par mois repose sur une idée banale, déjà occupée par des concurrents plus gros. Ce qui change tout, c'est la conception : où se situe le moment de valeur, quand apparaît l'offre, ce qui retient au troisième mois. Deux applications avec la même idée et le même nombre d'utilisateurs peuvent avoir un rapport de un à dix sur le revenu.</p>
      ...
      <p>Reprends les six raisons une par une sur ton projet et note honnêtement celles qui s'appliquent. Dans la plupart des cas, deux ou trois suffisent à expliquer l'absence de revenus. Pour la vue d'ensemble du sujet, lis <a href="/blog/rentabiliser-application-mobile">comment rentabiliser une application mobile</a>. Si tu veux une lecture rapide du potentiel de revenus, du budget et du délai de ton projet, fais ton <a href="/audit-app">audit gratuit</a> en deux minutes.</p>
    `,
  },
  {
