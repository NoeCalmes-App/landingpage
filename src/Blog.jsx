...
export const BLOG_ARTICLES = [
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>MVP — première version</strong> : à partir de 4 000 €. Une version ciblée sur les fonctionnalités essentielles, livrée en 45 jours environ. L'objectif : valider votre idée sans tout miser d'un coup.</li>
